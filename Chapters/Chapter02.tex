...
\begin{figure}
	\center{
        {\includegraphics[width=0.9\linewidth]{gfx/greenbergGroupDraw}}
...
Die Praxiserfahrungen mit \emph{GroupSketch}, \emph{XGroupSketch} und \linebreak\emph{GroupDraw} zeigen, dass neben den von Tang definierten Designkriterien \citep{TangJC:1989} noch folgende Faktoren bei der Entwicklung von Groupware Zeichenapplikationen von Bedeutung sind:
